...
@EnableEurekaClient
@EnableZuulProxy
@OpenAPIDefinition(info = @Info(title = "Zuul API Gateway", version = "1.0", description = "Documentation Zuul API v1.0"))
//@CrossOrigin(origins = "*")
@Configuration
public class ZuulSecurityApplication {
	...
	public OpenAPI customOpenAPI(@Value("1.5.2") String appVersion) {
		return new OpenAPI().components(new Components())
				.info(new io.swagger.v3.oas.models.info.Info().title("Zuul API Gateway").version(appVersion)
